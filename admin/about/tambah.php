          ...
          <form action="proses_simpan.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="judul_about_post" class="form-control" placeholder="Masukan Judul about" required>
              </div>
              <div class="form-group">
                <label>Nama About</label>
                <input type="text" name="isi_about_post" class="form-control" placeholder="Masukan isi about" required>
              </div>
