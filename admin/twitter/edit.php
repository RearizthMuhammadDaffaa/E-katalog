          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Edit Twitter</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <form action="proses_edit.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="judul_twitter_post" class="form-control" placeholder="Masukan judul twitter" value="<?= $judul_twitter ?>" required>
              </div>
              <div class="form-group">
                <label>isi twitter</label>
                <input type="text" name="isi_twitter_post" class="form-control" placeholder="Masukan isi twitter" value="<?= $isi_twitter ?>" required>
              </div>
              <!-- /.card-body -->
