    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Tambah Twitter</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item
active">Tambah Twitter</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <form action="proses_simpan.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="judul_twitter_post" class="form-control" placeholder="Masukan Judul Twitter" required>
              </div>
              <div class="form-group">
                <label>isi Twitter</label>
                <input type="text" name="isi_twitter_post" class="form-control" placeholder="Masukan isi Twitter" required>
              </div>
