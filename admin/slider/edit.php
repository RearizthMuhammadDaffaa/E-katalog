          ...
          <form action="proses_edit.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama_sosmed_post" class="form-control" placeholder="Masukan Nama social" value="<?= $nama_sosmed ?>" required>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="file" name="icon_post" class="form-control" value="gambar/<?=$icon;?>" required>
