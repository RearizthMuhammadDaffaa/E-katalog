          ...
          <form action="proses_edit.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <label >Kategori</label>
                <select name="kategori-post"  class="form-control" required>
                  ...
                  ?>
                  <option value="<?= $data['id']; ?>" <?php if($data['id'] == $ikategori ):?><?= 'selected' ?><?php endif ?>><?= $data['nama_kategori']; ?></option>
                  <?php endwhile ?>
                </select>
